#ifndef PROTO_TCP_THREADS_SRC_TCP_COMMON_LOGIC_SCHEDULER_H_
#define PROTO_TCP_THREADS_SRC_TCP_COMMON_LOGIC_SCHEDULER_H_
...
#endif // PROTO_TCP_THREADS_SRC_TCP_COMMON_LOGIC_SCHEDULER_H_
