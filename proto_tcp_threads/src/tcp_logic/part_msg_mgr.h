#ifndef PROTO_TCP_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
#define PROTO_TCP_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
...
#endif // PROTO_TCP_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
