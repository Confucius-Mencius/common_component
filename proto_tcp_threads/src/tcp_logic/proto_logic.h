#ifndef PROTO_TCP_THREADS_SRC_TCP_LOGIC_PROTO_LOGIC_H_
#define PROTO_TCP_THREADS_SRC_TCP_LOGIC_PROTO_LOGIC_H_
...
#endif // PROTO_TCP_THREADS_SRC_TCP_LOGIC_PROTO_LOGIC_H_
