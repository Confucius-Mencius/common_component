#ifndef WEB_THREADS_INC_HTTP_MSG_HANDLER_MGR_TEMPLATE_H_
#define WEB_THREADS_INC_HTTP_MSG_HANDLER_MGR_TEMPLATE_H_
...
#endif // WEB_THREADS_INC_HTTP_MSG_HANDLER_MGR_TEMPLATE_H_
