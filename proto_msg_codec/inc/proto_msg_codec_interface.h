#ifndef PROTO_MSG_CODEC_INC_PROTO_MSG_CODEC_INTERFACE_H_
#define PROTO_MSG_CODEC_INC_PROTO_MSG_CODEC_INTERFACE_H_
...
class MsgCodecInterface : public ModuleInterface
{
public:
...
//    virtual bool IsWholeMsg(MsgID& err_msg_id, size_t& total_msg_len, struct evbuffer* ev_buf) = 0;
    ...
    virtual bool IsWholeMsg(MsgID& err_msg_id, size_t& total_msg_len, const char* data, size_t len) = 0;
     ...
     * @return =0表示成功，否则失败
     */
    virtual int EncodeMsg(char** data, size_t& len, const MsgHead& msg_head, const void* msg_body,
                          size_t msg_body_len) = 0;
};
}

#endif // PROTO_MSG_CODEC_INC_PROTO_MSG_CODEC_INTERFACE_H_
