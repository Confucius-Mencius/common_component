#ifndef APP_FRAME_INC_UDP_PROTOBUF_MSG_UTIL_H_
#define APP_FRAME_INC_UDP_PROTOBUF_MSG_UTIL_H_

#include "udp_scheduler_interface.h"
#include "protobuf_msg_util.h"

inline int SendToClient(udp::SchedulerInterface* scheduler, const ConnGuid* conn_guid,
...
inline int SendToUdpThread(udp::SchedulerInterface* scheduler, const ConnGuid* conn_guid,
...
inline int SendToWorkThread(udp::SchedulerInterface* scheduler, const ConnGuid* conn_guid,
...
inline int SendToGlobalThread(udp::SchedulerInterface* scheduler, const ConnGuid* conn_guid,
                              const MsgHead& msg_head, const google::protobuf::Message* protobuf_msg)
{
    char* msg_body = NULL;
    size_t msg_body_len = 0;
...
#endif // APP_FRAME_INC_UDP_PROTOBUF_MSG_UTIL_H_
