...
public:
    ...
    virtual int GetHTTPWSPort() = 0;
    virtual int GetHTTPWSSecurityPort() = 0;
    virtual std::string GetHTTPWSCertificateChainFilePath() = 0;
    virtual std::string GetHTTPWSPrivateKeyFilePath() = 0;
    virtual int GetHTTPWSThreadCount() = 0;
    virtual std::string GetHTTPWSCommonLogicSo() = 0;
    virtual StrGroup GetHTTPWSLogicSoGroup() = 0;
