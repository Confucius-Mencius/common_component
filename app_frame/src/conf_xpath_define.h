...
const char WS_PORT_XPATH[] = "/conf/ws/ws_port";
const char WSS_PORT_XPATH[] = "/conf/ws/wss_port";
const char WSS_CERTIFICATE_CHAIN_FILE_PATH_XPATH[] = "/conf/ws/certificate_chain_file_path";
const char WSS_PRIVATE_KEY_FILE_PATH_XPATH[] = "/conf/ws/private_key_file_path";
