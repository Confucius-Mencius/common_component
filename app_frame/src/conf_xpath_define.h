...
const char WS_IFACE_XPATH[] = "/conf/ws/iface";
...
const char WS_NETWORK_ROUNDTRIP_TIMEOUT_XPATH[] = "/conf/ws/network_roundtrip_timeout";
const char WS_PING_PONG_INTERVAL_XPATH[] = "/conf/ws/ping_pong_interval";
const char WS_CONN_COUNT_LIMIT_XPATH[] = "/conf/ws/conn_count_limit";
const char WS_INACTIVE_CONN_CHECK_INTERVAL_SEC_XPATH[] = "/conf/ws/inactive_conn/check_interval/sec";
const char WS_INACTIVE_CONN_CHECK_INTERVAL_USEC_XPATH[] = "/conf/ws/inactive_conn/check_interval/usec";
const char WS_INACTIVE_CONN_LIFE_XPATH[] = "/conf/ws/inactive_conn/life";
const char WS_STORM_INTERVAL_XPATH[] = "/conf/ws/storm_interval";
const char WS_STORM_THRESHOLD_XPATH[] = "/conf/ws/storm_threshold";
...
const char HTTP_KEEPALIVE_TIMEOUT_XPATH[] = "/conf/ws/http/keepalive_timeout";
const char HTTP_COMMON_LOGIC_SO_XPATH[] = "/conf/ws/http/common_logic_so";
const char HTTP_LOGIC_SO_XPATH[] = "/conf/ws/http/logic_so_group/logic_so";
