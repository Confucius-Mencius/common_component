...
const char TCP_DO_CHECKSUM_XPATH[] = "/conf/tcp/do_checksum";
const char TCP_MAX_MSG_BODY_LEN_XPATH[] = "/conf/tcp/max_msg_body_len";
const char TCP_PART_MSG_CHECK_INTERVAL_XPATH[] = "/conf/tcp/part_msg/check_interval";
const char TCP_PART_MSG_CONN_LIFE_XPATH[] = "/conf/tcp/part_msg/conn_life";
...
const char RAW_TCP_ADDR_PORT_XPATH[] = "/conf/raw_tcp/addr_port";
const char RAW_TCP_CONN_COUNT_LIMIT_XPATH[] = "/conf/raw_tcp/conn_count_limit";
const char RAW_TCP_INACTIVE_CONN_CHECK_INTERVAL_SEC_XPATH[] = "/conf/raw_tcp/inactive_conn/check_interval/sec";
const char RAW_TCP_INACTIVE_CONN_CHECK_INTERVAL_USEC_XPATH[] = "/conf/raw_tcp/inactive_conn/check_interval/usec";
const char RAW_TCP_INACTIVE_CONN_LIFE_XPATH[] = "/conf/raw_tcp/inactive_conn/life";
const char RAW_TCP_THREAD_COUNT_XPATH[] = "/conf/raw_tcp/thread_count";
const char RAW_TCP_LOCAL_LOGIC_SO_XPATH[] = "/conf/raw_tcp/local_logic_so";
const char RAW_TCP_LOGIC_SO_XPATH[] = "/conf/raw_tcp/logic_so_group/logic_so";
