...
const char HTTP_WS_PART_MSG_CHECK_INTERVAL_XPATH[] = "/conf/http_ws/part_msg/check_interval";
const char HTTP_WS_PART_MSG_CONN_LIFE_XPATH[] = "/conf/http_ws/part_msg/conn_life";
const char HTTP_WS_ADDR_XPATH[] = "/conf/http_ws/addr";
const char HTTP_WS_PORT_XPATH[] = "/conf/http_ws/port";
const char HTTP_WS_SECURITY_PORT_XPATH[] = "/conf/http_ws/security/port";
const char HTTP_WS_CERTIFICATE_CHAIN_FILE_PATH_XPATH[] = "/conf/http_ws/security/certificate_chain_file_path";
const char HTTP_WS_PRIVATE_KEY_FILE_PATH_XPATH[] = "/conf/http_ws/security/private_key_file_path";
const char HTTP_WS_THREAD_COUNT_XPATH[] = "/conf/http_ws/thread_count";
const char HTTP_WS_COMMON_LOGIC_SO_XPATH[] = "/conf/http_ws/common_logic_so";
const char HTTP_WS_LOGIC_SO_XPATH[] = "/conf/http_ws/logic_so_group/logic_so";
