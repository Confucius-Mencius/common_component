#ifndef WS_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
#define WS_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
...
public:
    ...
    virtual void OnGet(const ConnGUID* conn_guid, bool https,
                       const KeyValMap* http_header_map, const KeyValMap* http_query_map) = 0;

    virtual void OnPost(const ConnGUID* conn_guid, bool https,
...
#endif // WS_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
