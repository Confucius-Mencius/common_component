...
{
    printf("started new chunk, %lu bytes\n", len);
...
//    evhtp_set_hook(&request->hooks, evhtp_hook_on_read, (evhtp_hook) print_data, evbase);
//    evhtp_set_hook(&request->hooks, evhtp_hook_on_new_chunk, (evhtp_hook) print_new_chunk_len, NULL);
//    evhtp_set_hook(&request->hooks, evhtp_hook_on_chunk_complete, (evhtp_hook) print_chunk_complete, NULL);
//    evhtp_set_hook(&request->hooks, evhtp_hook_on_chunks_complete, (evhtp_hook) print_chunks_complete, NULL);
