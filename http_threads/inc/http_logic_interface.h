#ifndef HTTP_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
#define HTTP_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
...
struct LogicCtx
{
    ...
    MsgDispatcherInterface* msg_dispatcher;
...
#endif // HTTP_THREADS_INC_HTTP_LOGIC_INTERFACE_H_
