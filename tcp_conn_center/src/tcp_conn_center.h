#ifndef TCP_CONN_CENTER_SRC_TCP_CONN_CENTER_H_
#define TCP_CONN_CENTER_SRC_TCP_CONN_CENTER_H_
...
namespace tcp
{
class ConnCenter : public ConnCenterInterface, public RecordTimeoutMgr<ConnID, std::hash<ConnID>, ConnInterface*>
{
public:
    ConnCenter();
    virtual ~ConnCenter();
...
#endif // TCP_CONN_CENTER_SRC_TCP_CONN_CENTER_H_
