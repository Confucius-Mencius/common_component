#ifndef GLOBAL_THREADS_SRC_WORK_LOGIC_PROTO_LOGIC_ARGS_H_
#define GLOBAL_THREADS_SRC_WORK_LOGIC_PROTO_LOGIC_ARGS_H_
...
#endif // GLOBAL_THREADS_SRC_WORK_LOGIC_PROTO_LOGIC_ARGS_H_
