#ifndef GLOBAL_THREADS_SRC_WORK_LOGIC_COMMON_LOGIC_H_
#define GLOBAL_THREADS_SRC_WORK_LOGIC_COMMON_LOGIC_H_
...
#endif // GLOBAL_THREADS_SRC_WORK_LOGIC_COMMON_LOGIC_H_
