...
GlobalLogic::GlobalLogic() : global_logic_args_(), global_logic_loader_(), scheduler_(), msg_dispatcher_()
{
...
const char* GlobalLogic::GetVersion() const
{
    return nullptr;
}

const char* GlobalLogic::GetLastErrMsg() const
{
    return nullptr;
}

void GlobalLogic::Release()
{
...
int GlobalLogic::Initialize(const void* ctx)
{
...
void GlobalLogic::Finalize()
{
    SAFE_FINALIZE(global_logic_);
}

int GlobalLogic::Activate()
{
...
void GlobalLogic::Freeze()
{
    SAFE_FREEZE(global_logic_);
}

void GlobalLogic::OnStop()
{
...
void GlobalLogic::OnTask(const ConnGUID* conn_guid, ThreadInterface* source_thread, const void* data, size_t len)
{
...
void GlobalLogic::OnTimer(TimerID timer_id, void* data, size_t len, int times)
{
    int can_exit = 1;
...
int GlobalLogic::LoadGlobalLogic()
{
