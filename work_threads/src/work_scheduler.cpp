                                ...
                                size_t msg_body_len, int work_thread_idx)
{
    ...
    ThreadInterface* work_thread = thread_sink_->GetWorkThreadGroup()->GetThread(real_work_thread_idx);
                                  ...
                                  size_t msg_body_len, int burden_thread_idx)
{
    ...
    ThreadInterface* burden_thread = related_thread_group_->burden_thread_group->GetThread(real_burden_thread_idx);
                                ...
                                size_t msg_body_len, int http_thread_idx)
{
    ...
    TaskCtx task_ctx;
    task_ctx.task_type = TASK_TYPE_WORK_RETURN_TO_HTTP;
    task_ctx.source_thread = thread_sink_->GetThread();
...
void Scheduler::SetRelatedThreadGroup(RelatedThreadGroup* related_thread_group)
{
    ...
    if (related_thread_group_->burden_thread_group != NULL)
    {
