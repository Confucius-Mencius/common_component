#ifndef BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_COMMON_LOGIC_H_
#define BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_COMMON_LOGIC_H_
...
class BurdenCommonLogic : public CommonLogicInterface, public TimerSinkInterface
{
public:
    BurdenCommonLogic();
    virtual ~BurdenCommonLogic();
...
#endif // BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_COMMON_LOGIC_H_
