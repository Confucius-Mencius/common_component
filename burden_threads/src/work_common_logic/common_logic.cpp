...
BurdenCommonLogic::BurdenCommonLogic() : burden_logic_args_(), burden_common_logic_loader_(),
    burden_logic_item_vec_(), scheduler_(), msg_dispatcher_()
{
    burden_common_logic_ = nullptr;
}

BurdenCommonLogic::~BurdenCommonLogic()
{
}

const char* BurdenCommonLogic::GetVersion() const
{
    return nullptr;
}

const char* BurdenCommonLogic::GetLastErrMsg() const
{
    return nullptr;
}

void BurdenCommonLogic::Release()
{
...
int BurdenCommonLogic::Initialize(const void* ctx)
{
...
void BurdenCommonLogic::Finalize()
{
    for (BurdenLogicItemVec::iterator it = burden_logic_item_vec_.begin(); it != burden_logic_item_vec_.end(); ++it)
    {
...
int BurdenCommonLogic::Activate()
{
...
void BurdenCommonLogic::OnReload()
{
    if (burden_common_logic_ != nullptr)
    {
...
void BurdenCommonLogic::OnTask(const ConnGUID* conn_guid, ThreadInterface* source_thread, const void* data, size_t len)
{
...
void BurdenCommonLogic::OnTimer(TimerID timer_id, void* data, size_t len, int times)
{
    int can_exit = 1;
...
int BurdenCommonLogic::LoadBurdenCommonLogic()
{
...
int BurdenCommonLogic::LoadBurdenLogicGroup()
{
    // logic so group
