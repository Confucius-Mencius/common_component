#ifndef BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_PROTO_LOGIC_ARGS_H_
#define BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_PROTO_LOGIC_ARGS_H_
...
#endif // BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_PROTO_LOGIC_ARGS_H_
