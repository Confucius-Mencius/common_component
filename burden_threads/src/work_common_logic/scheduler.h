#ifndef BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_SCHEDULER_H_
#define BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_SCHEDULER_H_
...
#endif // BURDEN_THREADS_SRC_WORK_COMMON_LOGIC_SCHEDULER_H_
