#ifndef BURDEN_THREADS_SRC_WORK_LOGIC_BURDEN_LOGIC_H_
#define BURDEN_THREADS_SRC_WORK_LOGIC_BURDEN_LOGIC_H_
...
#endif // BURDEN_THREADS_SRC_WORK_LOGIC_BURDEN_LOGIC_H_
