#ifndef HTTP_WS_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
#define HTTP_WS_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
...
#endif // HTTP_WS_THREADS_SRC_TCP_LOGIC_PART_MSG_MGR_H_
