#ifndef HTTP_WS_THREADS_SRC_TCP_LOGIC_THE_WS_PARSER_H_
#define HTTP_WS_THREADS_SRC_TCP_LOGIC_THE_WS_PARSER_H_
...
#endif // HTTP_WS_THREADS_SRC_TCP_LOGIC_THE_WS_PARSER_H_
