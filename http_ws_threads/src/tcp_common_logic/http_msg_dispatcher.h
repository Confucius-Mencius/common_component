#ifndef HTTP_THREADS_SRC_TCP_COMMON_LOGIC_HTTP_MSG_DISPATCHER_H_
#define HTTP_THREADS_SRC_TCP_COMMON_LOGIC_HTTP_MSG_DISPATCHER_H_
...
#endif // HTTP_THREADS_SRC_TCP_COMMON_LOGIC_HTTP_MSG_DISPATCHER_H_
